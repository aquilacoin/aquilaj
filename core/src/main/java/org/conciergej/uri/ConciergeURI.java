...
import org.conciergej.params.AbstractBitcoinNetParams;
...
public class ConciergeURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.conciergej.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.conciergej.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    /**
     * Constructs a new ConciergeURI from the given string. Can be for any network.
     *
     ...
     */
    public ConciergeURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public ConciergeURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("ConciergeURI[");
        boolean first = true;
