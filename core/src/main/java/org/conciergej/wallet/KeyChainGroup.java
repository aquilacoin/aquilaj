...
/**
 * <p>A KeyChainGroup is used by the {@link org.conciergej.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.conciergej.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.conciergej.crypto.KeyCrypterScrypt}.
     *
     * @throws org.conciergej.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
