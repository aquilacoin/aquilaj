...
import org.conciergej.core.Message;
import org.conciergej.core.listeners.*;
import org.conciergej.core.TransactionConfidence.*;
import org.conciergej.crypto.*;
import org.conciergej.script.*;
import org.conciergej.signers.*;
import org.conciergej.utils.*;
import org.conciergej.wallet.Protos.Wallet.*;
import org.conciergej.wallet.WalletTransaction.*;
...
import org.conciergej.wallet.listeners.WalletEventListener;
import org.conciergej.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.conciergej.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.conciergej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.conciergej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.conciergej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.conciergej.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.conciergej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.conciergej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.conciergej.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.conciergej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.conciergej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.conciergej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.conciergej.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.conciergej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.conciergej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of conciergej. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.conciergej.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.conciergej.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.conciergej.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.conciergej.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.conciergej.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.conciergej.crypto.KeyCrypter,
     ...
     * {@link org.conciergej.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.conciergej.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.conciergej.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.conciergej.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.conciergej.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.conciergej.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
