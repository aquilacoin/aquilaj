...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link org.conciergej.wallet.Wallet}. Key chains
...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the conciergej protobuf format. */
     ...
     *
     * <p>See the docs for {@link org.conciergej.core.BloomFilter#BloomFilter(int, double, long)} for a brief
