...
import org.conciergej.core.BloomFilter;
 ...
 * {@link org.conciergej.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.conciergej.crypto.MnemonicCode},
 ...
 * {@link org.conciergej.crypto.DeterministicKey#serializePubB58(org.conciergej.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.conciergej.crypto.DeterministicKey#deserializeB58(org.conciergej.crypto.DeterministicKey, String, org.conciergej.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.conciergej.crypto.DeterministicKey,KeyChainType keyChaintype)}.</p>
 *
 * <p>This class builds on {@link org.conciergej.crypto.DeterministicHierarchy} and
 * {@link org.conciergej.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from conciergej users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.conciergej.crypto.DeterministicKey)}
     ...
     * @see org.conciergej.wallet.MarriedKeyChain
     */
