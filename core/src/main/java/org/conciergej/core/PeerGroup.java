...
import org.conciergej.net.*;
import org.conciergej.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of conciergej fixes the known
     ...
     * {@link org.conciergej.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.conciergej.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.conciergej.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.conciergej.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.conciergej.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.conciergej.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.conciergej.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.conciergej.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.conciergej.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a conciergej based app running in SPV mode to fully validating security.
     */
