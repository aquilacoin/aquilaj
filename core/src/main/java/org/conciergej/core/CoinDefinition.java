...
public class CoinDefinition {
    ...
    public static final String ID_MAINNET = "org.concierge.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.concierge.test";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.google.concierge.unittest";
