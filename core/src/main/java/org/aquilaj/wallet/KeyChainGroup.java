...
/**
 * <p>A KeyChainGroup is used by the {@link org.aquilaj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.aquilaj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.aquilaj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.aquilaj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
