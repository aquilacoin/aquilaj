...
import org.aquilaj.crypto.KeyCrypterException;
...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(org.aquilaj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link org.aquilaj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link org.aquilaj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
