...
import org.aquilaj.core.Message;
import org.aquilaj.core.listeners.*;
import org.aquilaj.core.TransactionConfidence.*;
import org.aquilaj.crypto.*;
import org.aquilaj.script.*;
import org.aquilaj.signers.*;
import org.aquilaj.utils.*;
import org.aquilaj.wallet.Protos.Wallet.*;
import org.aquilaj.wallet.WalletTransaction.*;
import org.aquilaj.wallet.listeners.KeyChainEventListener;
import org.aquilaj.wallet.listeners.ScriptsChangeEventListener;
...
import org.aquilaj.wallet.listeners.WalletCoinsSentEventListener;
import org.aquilaj.wallet.listeners.WalletEventListener;
import org.aquilaj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.aquilaj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
    ...
    private Wallet(Context context, KeyChainGroup keyChainGroup) {
        ...
        //this.version = this.keyChainGroup.getActiveKeyChain().getKeyChainType() == DeterministicKeyChain.KeyChainType.BIP44_AQX_ONLY? 1 : 0;
     ...
     * {@link org.aquilaj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.aquilaj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.aquilaj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.aquilaj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.aquilaj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.aquilaj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.aquilaj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.aquilaj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.aquilaj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.aquilaj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.aquilaj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.aquilaj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.aquilaj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of aquilaj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.aquilaj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.aquilaj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.aquilaj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.aquilaj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.aquilaj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.aquilaj.crypto.KeyCrypter,
     ...
     * {@link org.aquilaj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.aquilaj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.aquilaj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.aquilaj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.aquilaj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.aquilaj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
