...
public class DeterministicKey extends ECKey {
    ...
    /**
     * Returns this keys {@link org.aquilaj.crypto.KeyCrypter} <b>or</b> the keycrypter of its parent key.
     */
    @Override @Nullable
    ...
    public static DeterministicKey deserialize(NetworkParameters params, byte[] serializedKey, @Nullable DeterministicKey parent, DeterministicKeyChain.KeyChainType keyChainType) {
        ...
        if (parent != null) {
            ...
            if (depth >= 1)
                ...
                // parent's node.
                if (keyChainType == DeterministicKeyChain.KeyChainType.BIP44_AQX_ONLY){
     ...
     * in which case the time is stored alongside the key as per normal, see {@link org.aquilaj.core.ECKey#getCreationTimeSeconds()}.
     */
    @Override
