...
import org.aquilaj.protocols.channels.*;
import org.aquilaj.store.*;
import org.aquilaj.wallet.*;
import org.slf4j.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV aquilaj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit aquilaj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing aquilaj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * {@link org.aquilaj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the aquilaj website for further details.
     */
