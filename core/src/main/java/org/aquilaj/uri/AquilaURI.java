...
import org.aquilaj.params.AbstractBitcoinNetParams;
...
public class AquilaURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.aquilaj.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.aquilaj.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    /**
     * Constructs a new AquilaURI from the given string. Can be for any network.
     *
     ...
     */
    public AquilaURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public AquilaURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("AquilaURI[");
        boolean first = true;
