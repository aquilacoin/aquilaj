...
import org.aquilaj.net.discovery.HttpDiscovery;
import org.aquilaj.params.*;
import org.aquilaj.script.Script;
import org.aquilaj.script.ScriptBuilder;
import org.aquilaj.script.ScriptChunk;
import org.aquilaj.script.ScriptOpCodes;
...
import org.aquilaj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_REGTEST = "org.aquila.regtest";
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.aquilaj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.aquilaj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.aquilaj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.aquilaj.core.AlertMessage}s. You can use {@link org.aquilaj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
