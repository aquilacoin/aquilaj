 ...
 * the lightweight SPV mode, a {@link org.aquilaj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.aquilaj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
