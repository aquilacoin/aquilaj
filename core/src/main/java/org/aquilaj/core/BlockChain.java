...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link org.aquilaj.store.SPVBlockStore} or you could also try a
     * {@link org.aquilaj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
