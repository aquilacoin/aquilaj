 ...
 *
 * <p>TransactionConfidence is updated via the {@link org.aquilaj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link org.aquilaj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link org.aquilaj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        enum ChangeReason {
            /**
             * Occurs when the type returned by {@link org.aquilaj.core.TransactionConfidence#getConfidenceType()}
            ...
            SEEN_PEERS,
            /**
             * Occurs when the type returned by {@link org.aquilaj.core.TransactionConfidence#getIXType()}
     ...
     * and so on. This information is useful for {@link org.aquilaj.wallet.CoinSelector} implementations to risk analyze
