...
import org.aquilaj.crypto.TransactionSignature;
...
import static org.aquilaj.core.Utils.*;
...
public class Transaction extends ChildMessage {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, org.aquilaj.script.Script, ECKey, org.aquilaj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], org.aquilaj.core.Transaction.SigHash, boolean)}
    ...
    /**
     * Returns the confidence object for this transaction from the {@link org.aquilaj.core.TxConfidenceTable}
