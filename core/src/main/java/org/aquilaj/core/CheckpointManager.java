...
import org.aquilaj.store.FullPrunedBlockStore;
 ...
 * {@link org.aquilaj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with aquilaj */
    ...
    /** Returns a checkpoints stream pointing to inside the aquilaj JAR */
