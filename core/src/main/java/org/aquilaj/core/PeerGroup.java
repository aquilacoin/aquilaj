...
import org.aquilaj.net.*;
import org.aquilaj.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of aquilaj fixes the known
     ...
     * {@link org.aquilaj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.aquilaj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.aquilaj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.aquilaj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.aquilaj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.aquilaj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.aquilaj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.aquilaj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.aquilaj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a aquilaj based app running in SPV mode to fully validating security.
     */
