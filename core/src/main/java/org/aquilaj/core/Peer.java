...
import org.aquilaj.net.StreamConnection;
import org.aquilaj.store.BlockStore;
import org.aquilaj.store.BlockStoreException;
import org.aquilaj.utils.ListenerRegistration;
 ...
 * {@link org.aquilaj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.aquilaj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.aquilaj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.aquilaj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.aquilaj.core.TxConfidenceTable}
    ...
    protected void processMessage(Message m) throws Exception {
        ...
        else if(m instanceof SporkMessage)
        {
            ...
            // todo furszy: check aquila masternodes
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // aquilaj is a client mode implementation. That means there's not much point in us talking to other client
...
//            if(!instantSend.mapTxLockVotes.containsKey(item.hash))
     ...
     * Once the pong is received the value returned by {@link org.aquilaj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.aquilaj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.aquilaj.core.Peer#ping()} has never
