...
import org.aquilaj.net.AbstractTimeoutHandler;
import org.aquilaj.net.MessageWriteTarget;
 ...
 * {@link org.aquilaj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
     ...
     * called automatically by {@link org.aquilaj.net.NioClient} or
     * {@link org.aquilaj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
