...
import org.aquilaj.core.AbstractBlockChain;
...
import org.aquilaj.core.PeerAddress;
...
import org.aquilaj.core.VerificationException;
import org.aquilaj.core.TransactionConfidence.ConfidenceType;
import org.aquilaj.crypto.*;
import org.aquilaj.script.Script;
import org.aquilaj.script.ScriptBuilder;
import org.aquilaj.signers.StatelessTransactionSigner;
import org.aquilaj.signers.TransactionSigner;
import org.aquilaj.store.BlockStoreException;
import org.aquilaj.store.MemoryBlockStore;
import org.aquilaj.testing.*;
import org.aquilaj.utils.ExchangeRate;
import org.aquilaj.utils.Fiat;
import org.aquilaj.utils.Threading;
import org.aquilaj.wallet.Wallet.BalanceType;
import org.aquilaj.wallet.WalletTransaction.Pool;
...
import org.aquilaj.wallet.Protos.Wallet.EncryptionType;
...
import static org.aquilaj.core.Utils.HEX;
import static org.aquilaj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: aquilaj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("aquilaj-unit-test", null);
