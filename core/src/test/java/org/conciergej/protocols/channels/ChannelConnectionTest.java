...
import org.conciergej.testing.TestWithWallet;
...
import static org.conciergej.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.conciergej.testing.FakeTxBuilder.createFakeBlock;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.conciergej.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
