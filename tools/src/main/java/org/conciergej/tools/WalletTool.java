...
import org.conciergej.protocols.payments.PaymentProtocol;
import org.conciergej.protocols.payments.PaymentProtocolException;
import org.conciergej.protocols.payments.PaymentSession;
import org.conciergej.script.ScriptBuilder;
import org.conciergej.store.*;
import org.conciergej.uri.ConciergeURI;
import org.conciergej.uri.BitcoinURIParseException;
import org.conciergej.utils.BriefLogFormatter;
import org.conciergej.wallet.DeterministicSeed;
import org.conciergej.wallet.DeterministicUpgradeRequiredException;
import org.conciergej.wallet.DeterministicUpgradeRequiresPassword;
...
import org.conciergej.core.listeners.BlocksDownloadedEventListener;
import org.conciergej.core.listeners.DownloadProgressTracker;
import org.conciergej.wallet.MarriedKeyChain;
...
import static org.conciergej.core.Coin.parseCoin;
        ...
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            try {
                ...
                if (location.startsWith("http")) {
                    ...
                    ConciergeURI paymentRequestURI = new ConciergeURI(location);
