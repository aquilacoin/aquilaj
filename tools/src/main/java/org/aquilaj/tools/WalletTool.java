...
package org.aquilaj.tools;

import org.aquilaj.core.*;
import org.aquilaj.crypto.*;
import org.aquilaj.net.discovery.DnsDiscovery;
import org.aquilaj.params.MainNetParams;
import org.aquilaj.params.RegTestParams;
import org.aquilaj.params.TestNet3Params;
import org.aquilaj.protocols.payments.PaymentProtocol;
import org.aquilaj.protocols.payments.PaymentProtocolException;
import org.aquilaj.protocols.payments.PaymentSession;
import org.aquilaj.script.ScriptBuilder;
import org.aquilaj.store.*;
import org.aquilaj.uri.AquilaURI;
import org.aquilaj.uri.BitcoinURIParseException;
import org.aquilaj.utils.BriefLogFormatter;
import org.aquilaj.wallet.DeterministicSeed;
import org.aquilaj.wallet.DeterministicUpgradeRequiredException;
import org.aquilaj.wallet.DeterministicUpgradeRequiresPassword;
...
import static org.aquilaj.core.Coin.parseCoin;
        ...
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            try {
                ...
                if (location.startsWith("http")) {
                    ...
                    AquilaURI paymentRequestURI = new AquilaURI(location);
